...
LOCAL_DATA_FILE_LOCATION=/home/ubuntu/intermaclib/im-performance/$TEST_DATA_FOLDER_NAME
...
GREP_SCP='Bytes per second received\|Bytes encrypted received\|Bytes raw received'
